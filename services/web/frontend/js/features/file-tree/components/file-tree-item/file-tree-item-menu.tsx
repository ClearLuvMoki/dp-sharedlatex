...
function FileTreeItemMenu({ id, name, isSelected }: { id: string; name: string, isSelected: boolean }) {
  ...
  return (
    <div className="menu-button btn-group">
      ...
      >
        <MaterialIcon type="more_vert" accessibilityLabel={t('menu')}  style={{color: isSelected ? "#3c49dd": "#4E5969"}}/>
      </button>
    </div>
  )
}
